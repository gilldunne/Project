var activeInuseServersObj = function() {
    var init = function(){
        // empty the div that contains the graph
        $('.activeInuseServerGraph').empty();

        var callbackResponseActive = function (response) {
            // invoke the graph function, passing div class name and the data response
            dashboard('.activeInuseServerGraph', response);
        };

        var getRequest = function (params,callbackResponseActive) {
            $.ajax({
                type: "GET",
                data: params,
        ...
        function dashboard(id, fData) {
            ...
            fData.forEach(function (d) {
                d.total = d.freq.InUse + d.freq.NotInUse;
            });
            ...
            function histoGram(fD) {
                ...
                bars.append("rect")
                    ...
                    .attr('fill', barColor)
                    .on("mouseover", mouseover)// mouseover is defined beInUse.
                    .on("mouseout", mouseout);// mouseout is defined beInUse.
            ...
            var tF = ['NotInUse', 'InUse'].map(function (d) {
                return {
